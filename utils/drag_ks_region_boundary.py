...
# Stub function to replace external dependency
def replace_axis(fig, orientation='left', pos=None):
    """Stub replacement for atlaselectrophysiology.AdaptedAxisItem.replace_axis"""
    pass
 # Stub class to replace external dependency
class CriticalInsertionNote:
    """Stub replacement for ibllib.qc.critical_reasons.CriticalInsertionNote"""
    descriptions_gui = [
        "Poor signal quality",
        "Drift detected",
        "Noise contamination",
...
class Setup():
    def init_layout(self, main_window, offline=False):
        ...
        # Initialize data structures that may be referenced
        self.img_raw_data = {}
        self.img_stim_data = {}
        self.probe_rfmap = {}
        self.rfmap_boundaries = None
        self.probe_lfp_data = {}
        self.scat_drift_data = None
        self.scat_fr_data = None
        self.scat_p2t_data = None
        self.scat_amp_data = None
        self.img_fr_data = None
        self.img_corr_data = None
        self.img_rms_APdata = None
        self.img_rms_LFPdata = None
        self.img_lfp_data = None
        self.line_fr_data = None
        self.line_amp_data = None
        self.probe_rms_APdata = None
        self.probe_rms_LFPdata = None
    ...
    def init_region_lookup(self, allen):
        ...
        # Remove the first row which corresponds to 'Void' (if it exists)
        if len(allen) > 0:
            allen = allen.drop([0]).reset_index(drop=True) if len(allen) > 1 else allen
        ...
        if len(allen) > 0:
            ...
            if len(unique_levels) > 0:
                ...
                if len(idx) > 0:
                    item = QtGui.QStandardItem(allen['acronym'].iloc[idx[0]] + ': ' + allen['name'].iloc[idx[0]])
                    icon = QtGui.QPixmap(20, 20)
                    color_str = str(allen['color_hex_triplet'].iloc[idx[0]])
                    icon.fill(QtGui.QColor('#' + color_str))
                    item.setIcon(QtGui.QIcon(icon))
                    item.setAccessibleText(str(allen['id'].iloc[idx[0]]))
                    item.setEditable(False)
                    self.struct_list.appendRow(item)
                    parent_info.update({allen['structure_id_path'].iloc[idx[0]]: item})

                    for level in unique_levels[1:]:
                        idx_levels = np.where(allen['depth'] == level)[0]
                        for idx_val in idx_levels:
                            parent = allen['parent_path'].iloc[idx_val]
                            if parent in parent_info:
                                parent_item = parent_info[parent]
                                item = QtGui.QStandardItem(allen['acronym'].iloc[idx_val] + ': ' + allen['name'].iloc[idx_val])
                                color_str = str(allen['color_hex_triplet'].iloc[idx_val])
                                icon.fill(QtGui.QColor('#' + color_str))
                                item.setIcon(QtGui.QIcon(icon))
                                item.setAccessibleText(str(allen['id'].iloc[idx_val]))
                                item.setEditable(False)
                                parent_item.appendRow(item)
                                parent_info.update({allen['structure_id_path'].iloc[idx_val]: item})
...
# Stub classes for data loading
class LoadData:
    """Stub class for loading electrophysiology data"""
    def __init__(self, mode='auto', probe_id=None, one=None, load_histology=True, 
                 spike_collection=None):
        self.mode = mode
        self.probe_id = probe_id
        self.one = one
        self.load_histology = load_histology
    ...
    def get_info(self, shank_idx):
        """Return info tuple and histology_exists flag"""
        return {}, False
    
    def get_starting_alignment(self, shank_idx):
        """Return feature_prev and track_prev"""
        return np.array([]), np.array([])
    
    def get_allen_csv(self):
        """Return Allen brain atlas CSV as DataFrame"""
...
class LoadDataLocal:
    """Stub class for loading local electrophysiology data"""
    def __init__(self):
        pass
...
class MainWindow(QtWidgets.QMainWindow, Setup):
    ...
    def plot_scatter(self, data):
        """Stub method for plotting scatter data"""
        pass
    
    def plot_image(self, data):
        """Stub method for plotting image data"""
        pass
    
    def plot_line(self, data):
        """Stub method for plotting line data"""
        pass
    
    def plot_probe(self, data, bounds=None):
        """Stub method for plotting probe data"""
        pass
    
    def plot_slice(self, data, slice_type):
        """Stub method for plotting slice data"""
        pass
    
    def filter_unit_pressed(self, unit_type):
        """Stub method for filtering units"""
        pass
    
    def fit_button_pressed(self):
        """Stub method for fit button"""
        pass
    
    def offset_button_pressed(self):
        """Stub method for offset button"""
        pass
    
    def moveup_button_pressed(self):
        """Stub method for move up button"""
        pass
    
    def movedown_button_pressed(self):
        """Stub method for move down button"""
        pass
    
    def delete_line_button_pressed(self):
        """Stub method for delete line button"""
        pass
    
    def next_button_pressed(self):
        """Stub method for next button"""
        pass
    
    def prev_button_pressed(self):
        """Stub method for previous button"""
        pass
    
    def reset_button_pressed(self):
        """Stub method for reset button"""
        pass
    
    def complete_button_pressed_offline(self):
        """Stub method for complete button (offline)"""
        pass
    
    def display_qc_options(self):
        """Stub method for displaying QC options"""
        pass
    
    def toggle_plots(self, group):
        """Stub method for toggling plots"""
        pass
    
    def set_view(self, view):
        """Stub method for setting view"""
        pass
    
    def reset_axis_button_pressed(self):
        """Stub method for reset axis button"""
        pass
    
    def toggle_labels_button_pressed(self):
        """Stub method for toggle labels button"""
        pass
    
    def toggle_line_button_pressed(self):
        """Stub method for toggle line button"""
        pass
    
    def toggle_channel_button_pressed(self):
        """Stub method for toggle channel button"""
        pass
    
    def toggle_histology_button_pressed(self):
        """Stub method for toggle histology button"""
        pass
    
    def toggle_histology_map_button_pressed(self):
        """Stub method for toggle histology map button"""
        pass
    
    def minimise_popups(self):
        """Stub method for minimising popups"""
        pass
    
    def close_popups(self):
        """Stub method for closing popups"""
        pass
    
    def save_plots(self):
        """Stub method for saving plots"""
        pass
    
    def display_session_notes(self):
        """Stub method for displaying session notes"""
        pass
    
    def describe_labels_pressed(self):
        """Stub method for describe labels"""
        pass
    
    def display_nearby_sessions(self):
        """Stub method for displaying nearby sessions"""
        pass
    
    def display_subject_scaling(self):
        """Stub method for displaying subject scaling"""
        pass
    
    def display_region_features(self):
        """Stub method for displaying region features"""
        pass
    
    def on_subject_selected(self, index):
        """Stub method for subject selection"""
        pass
    
    def on_session_selected(self, index):
        """Stub method for session selection"""
        pass
    
    def on_folder_selected(self):
        """Stub method for folder selection"""
        pass
    
    def on_alignment_selected(self, index):
        """Stub method for alignment selection"""
        pass
    
    def on_shank_selected(self, index):
        """Stub method for shank selection"""
        pass
    
    def data_button_pressed(self):
        """Stub method for data button"""
        pass
    
    def qc_button_clicked(self):
        """Stub method for QC button"""
        pass
    
    def label_pressed(self, index):
        """Stub method for label press"""
        pass
    
    def on_mouse_double_clicked(self, event):
        """Stub method for mouse double click"""
        pass
    
    def on_mouse_hover(self, event):
        """Stub method for mouse hover"""
        pass
    
    def lin_fit_option_changed(self, state):
        """Stub method for linear fit option change"""
        pass
    
    def populate_lists(self, items, model, combobox):
        """Stub method for populating lists"""
        pass
